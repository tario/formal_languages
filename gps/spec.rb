...
describe DsLisp, "GPS" do
  def lisp
    dslisp = DsLisp.new
    code = "(block " + File.open("gps.lsp").read + " )"
  ...
  it "should solve single path" do
    lisp.evaluate("(camino '((1 (2))) 1 2)").should be == [1, 2]
  end

  it "should solve alternate single path (1 3)" do
    lisp.evaluate("(camino '((1 (3))) 1 3)").should be == [1, 3]
  end

  it "should solve two step path (1 2 3)" do
    lisp.evaluate("(camino '((1 (2)) (2 (3))) 1 3)").should be == [1, 2, 3]
  end

  it "should solve two step path (1 2 3), with loops" do
    lisp.evaluate("(camino '((1 (2)) (2 (4 3 5)) (4 (1))) 1 3)").should be == [1, 2, 3]
  end

  it "should solve two step path (1 2 3), with alternate paths" do
    lisp.evaluate("(camino '((1 (2)) (2 (3 4)) (4 (5)) (5 (3))) 1 3)").should be == [1, 2, 3]
  end
end
